...
def plot_pos_var_in_dir(path1, path2):
    ...
    ax1.scatter(undist_lower_ball_x, undist_lower_ball_y, c="red")
    ax1.scatter(undist_upper_ball_x, undist_upper_ball_y, c="blue")
    ax1.set_xlim([0, 5])
    ax1.set_ylim([0, 5])
    ...
    ax2.scatter(undist_lower_ball_x, undist_lower_ball_y, c="red", label="Object 1")
    ax2.scatter(undist_upper_ball_x, undist_upper_ball_y, c="blue", label="Object 2")
    ax2.set_xlim([0, 5])
    ax2.set_ylim([0, 5])
