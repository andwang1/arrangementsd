...
def plot_loss_in_dir_VAE(path, full_loss=True, show_train_lines=False, save_path=None):
    os.chdir(path)
    FILE = f'ae_loss.dat'
    ...
    lns = ln1+ln2 if full_loss else ln1
...
if __name__ == "__main__":
    plot_loss_in_dir_VAE(
        "/home/andwang1/airl/balltrajectorysd/results_exp1/second_run/results_balltrajectorysd_vae/gen6001_random0.0_fulllosstrue/2020-06-03_19_28_26_161930")
