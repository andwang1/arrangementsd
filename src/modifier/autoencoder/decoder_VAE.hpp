...
struct DecoderImpl : torch::nn::Module {
    ...
    int latent_dim) :
        m_tconv_1(torch::nn::ConvTranspose2dOptions(latent_dim, de_hid_dim4, 5)),
        m_tconv_2(torch::nn::ConvTranspose2dOptions(de_hid_dim4, de_hid_dim3, 6)),
        m_tconv_3(torch::nn::ConvTranspose2dOptions(de_hid_dim3, de_hid_dim2, 6)),
        m_tconv_s(torch::nn::ConvTranspose2dOptions(de_hid_dim2, de_hid_dim1, 6).stride(2)),
        m_tconv_m(torch::nn::ConvTranspose2dOptions(de_hid_dim1, 1, 7)),
        m_tconv_v(torch::nn::ConvTranspose2dOptions(de_hid_dim1, 1, 7)),
        ...
        {
            torch::Tensor out = torch::relu(m_tconv_s(
        ...
        torch::nn::ConvTranspose2d m_tconv_1, m_tconv_2, m_tconv_3, 
